...
INSERT INTO `config_info` VALUES (4,'service-b.yml','DEFAULT_GROUP','server:\n  port: 9001\n  \nparams:\n  p2: 2222','b13942aa218b9797cd3c2b2a17c847ff','2020-05-19 15:02:33','2020-05-19 15:03:12',NULL,'172.19.0.1','','','null','null','null','yaml','null'),(5,'service-a.yml','DEFAULT_GROUP','server:\n  port: 9000\n\nfeign:\n  hystrix:\n    enabled: true\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: hystrix.stream,mappings\n  \nparams:\n  p1: 1111','f62b6b652e9b62682ddae96823507cd2','2020-05-19 15:02:56','2020-05-20 13:57:58',NULL,'172.19.0.1','','','null','null','null','yaml','null'),(8,'hystrix-dashboard.yml','DEFAULT_GROUP','server:\n  port: 9002\n\n','0414b33b9f256e62f0c7decdaa813a27','2020-05-19 16:18:47','2020-05-19 16:18:47',NULL,'172.19.0.1','','',NULL,NULL,NULL,'yaml',NULL);
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-20  6:05:03
