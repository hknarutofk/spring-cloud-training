...
INSERT INTO `config_info` VALUES (4,'service-b.yml','DEFAULT_GROUP','server:\n  port: 9001\n  servlet:\n    context-path: /service-b\n  \nparams:\n  p2: 2222','64fb92e14bf18d582b3bac8ae1e266f7','2020-05-19 15:02:33','2020-05-20 16:44:44',NULL,'172.19.0.1','','','null','null','null','yaml','null'),(5,'service-a.yml','DEFAULT_GROUP','server:\n  port: 9000\n  servlet:\n    context-path: /service-a\n\nfeign:\n  hystrix:\n    enabled: true\n\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: hystrix.stream,mappings\n  \nparams:\n  p1: 1111','928a363e1704ddda6bfa17df38915765','2020-05-19 15:02:56','2020-05-20 16:44:58',NULL,'172.19.0.1','','','null','null','null','yaml','null'),(8,'hystrix-dashboard.yml','DEFAULT_GROUP','server:\n  port: 9002\n  servlet:\n    context-path: /hystrix-dashboard\n\n','5a9f6bb32ab01e3d3e464103d5d1cfaa','2020-05-19 16:18:47','2020-05-20 16:45:27',NULL,'172.19.0.1','','','null','null','null','yaml','null'),(10,'gateway.yml','DEFAULT_GROUP','server:\n  port: 10000\n  servlet:\n    context-path: /\n\nspring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n      - id: hystrix_route\n        uri: lb://service-a/\n        predicates:\n        - Path=/service-a/**\n        filters:\n        - name: Hystrix\n          args:\n            name: fallbackcmd\n            fallbackUri: forward:/fallback       ','ffce38c9f15ffa540791adae654cce78','2020-05-20 14:34:03','2020-05-20 16:44:31',NULL,'172.19.0.1','','','null','null','null','yaml','null');
...
-- Dump completed on 2020-05-20  8:49:40
